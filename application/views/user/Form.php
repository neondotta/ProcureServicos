    ...
    <div class="valign-wrapper">
        <div class="form col s12 m10 l8">
            <div class="row">
                <?php
                    if(isset($perfil)) {
                        echo form_open_multipart('UserController/update');
                    } else {
                    ...
                    echo form_input([
                        ...
                        "class" => 'validate',
                        "maxlength" => 255,
                        "value" => isset($perfil) ? $perfil['latitude'] : ''
                    ]);
                    echo form_input([
                        "type" => 'hidden',
                        "name" => 'longitude',
                        ...
                        "class" => 'validate',
                        "maxlength" => 255,
                        "value" => isset($perfil) ? $perfil['longitude'] : ''
                    ]);
                ?>
                <div class="input-field col s12 m12 l12">
                    ...
                    echo form_input([
                        ...
                        "class" => 'validate',
                        "maxlength" => 255,
                        "value" => isset($perfil) ? $perfil['name'] : ''
                    ]);
                    ?>
                </div>
                ...
                <div class="input-field col s6">
                    <?php
                        ...
                        echo form_input([
                            ...
                            "class" => 'validate',
                            "maxlength" => 255,
                            "value" => isset($perfil) ? $perfil['nation'] : ''
                        ]);
                    ?>
                </div>
                <div class="input-field col s3">
                    <?php
                        ...
                        echo form_input([
                            ...
                            "class" => 'validate',
                            "maxlength" => 2,
                            "value" => isset($perfil) ? $perfil['country'] : ''
                        ]);
                    ?>
                </div>
                <div class="input-field col s9">
                    <?php
                        ...
                        echo form_input([
                            ...
                            "class" => 'validate',
                            "maxlength" => 255,
                            "value" => isset($perfil) ? $perfil['city'] : ''
                        ]);
                    ?>
                </div>
                <div class="input-field col s9">
                    <?php
                        ...
                        echo form_input([
                            ...
                            "class" => 'validate',
                            "maxlength" => 255,
                            "value" => isset($perfil) ? $perfil['street'] : ''
                        ]);
                    ?>
                </div>
                <div class="input-field col s3">
                    <?php
                        ...
                        echo form_input([
                            ...
                            "maxlength" => 255,
                            // "tabindex" => 2
                            "value" => isset($perfil) ? $perfil['number'] : ''
                        ]);
                    ?>
                </div>
                <div class="input-field col s6">
                    <?php
                        ...
                        echo form_input([
                            ...
                            "class" => 'validate',
                            "maxlength" => 255,
                            "value" => isset($perfil) ? $perfil['complement'] : ''
                        ]);
                    ?>
                </div>
                <div class="input-field col s6">
